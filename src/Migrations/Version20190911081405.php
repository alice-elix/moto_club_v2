 ...
 */
final class Version20190911081405 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD adresse VARCHAR(120) NOT NULL, ADD cp VARCHAR(10) NOT NULL, ADD ville VARCHAR(50) NOT NULL, ADD telephone VARCHAR(20) DEFAULT NULL, CHANGE pseudo pseudo VARCHAR(50) DEFAULT NULL, CHANGE nom nom VARCHAR(50) DEFAULT NULL, CHANGE prenom prenom VARCHAR(50) DEFAULT NULL, CHANGE avatar avatar VARCHAR(120) DEFAULT NULL, CHANGE datetime_adhesion datetime_adhesion DATETIME DEFAULT NULL');
    }
