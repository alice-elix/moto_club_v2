 ...
 */
final class Version20190917152943 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comptes_rendus DROP FOREIGN KEY fk_cr_reu_id');
        ...
        $this->addSql('ALTER TABLE comptes_rendus ADD CONSTRAINT FK_46141761631BB9D8 FOREIGN KEY (reu_id) REFERENCES reunions (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comptes_rendus CHANGE reu_id reu_id INT UNSIGNED DEFAULT NULL, CHANGE user_id user_id INT UNSIGNED DEFAULT NULL, CHANGE datetime_modif datetime_modif DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE comptes_rendus ADD CONSTRAINT fk_cr_reu_id FOREIGN KEY (reu_id) REFERENCES reunions (id)');
