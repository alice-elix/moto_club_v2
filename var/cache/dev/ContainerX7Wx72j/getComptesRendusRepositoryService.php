...
// Returns the private 'App\Repository\ComptesRendusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ComptesRendusRepository.php';

return $this->privates['App\\Repository\\ComptesRendusRepository'] = new \App\Repository\ComptesRendusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
