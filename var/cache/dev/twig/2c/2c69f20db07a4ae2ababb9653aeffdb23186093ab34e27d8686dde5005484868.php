...
class __TwigTemplate_84bfcb37762ceb33a07a0e9107aa44a58e94218a6b875e07fc8792ce8fa952e0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["bal_data"], "nb_photos", [], "any", false, false, false, 23) > 0)) {
                ...
                echo "\" class=\"btn btn-primary float-right ml-2\" role=\"button\" title=\"Voir les photos (";
...
\t\t\t\t\t\t\t";
            ...
            echo "\" class=\"btn btn-primary float-right\" role=\"button\">Afficher la balade</a>
\t\t\t\t\t\t\t<strong>";
            // line 29
...
";
    ...
    {
        return array (  179 => 42,  163 => 36,  160 => 35,  152 => 33,  146 => 31,  144 => 30,  140 => 29,  135 => 28,  129 => 26,  121 => 24,  119 => 23,  113 => 19,  109 => 18,  104 => 15,  98 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t\t\t\t\t\t\t<a href=\"{{ path('view_album', {id: bal_data.balade.getId()}) }}\" class=\"btn btn-primary float-right ml-2\" role=\"button\" title=\"Voir les photos ({{bal_data.nb_photos}})\"><i class=\"fas fa-images\"></i></a>
\t\t\t\t\t\t\t{% else %}
...
\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t<a href=\"{{ path('view_balade', {id: bal_data.balade.getId()}) }}\" class=\"btn btn-primary float-right\" role=\"button\">Afficher la balade</a>
...
{% endblock %}
", "balades/index.html.twig", "C:\\xampp\\htdocs\\moto_club\\templates\\balades\\index.html.twig");
    }
}
