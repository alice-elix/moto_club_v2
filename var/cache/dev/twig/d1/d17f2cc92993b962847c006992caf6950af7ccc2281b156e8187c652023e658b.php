...
class __TwigTemplate_04edeba37c7b1bc5d91fd820d7fbb9a813c47c4cbc2ee777e9938ade0bc76e9b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["success"]) || array_key_exists("success", $context) ? $context["success"] : (function () { throw new RuntimeError('Variable "success" does not exist.', 18, $this->source); })()) == true)) {
      ...
      <div class=\"card-body\">
        ...
        // line 35
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["crTrouve"]) || array_key_exists("crTrouve", $context) ? $context["crTrouve"] : (function () { throw new RuntimeError('Variable "crTrouve" does not exist.', 35, $this->source); })()), "getContenu", [], "method", false, false, false, 35), "html", null, true);
        echo "</textarea>
          </div>
            <div class=\"card-body\">
...
";
    ...
    {
        return array (  153 => 38,  147 => 35,  138 => 29,  124 => 21,  120 => 19,  118 => 18,  113 => 17,  111 => 16,  107 => 15,  102 => 13,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"card card-register mx-auto mt-5\">
      ...
      <div class=\"card-body\">
        <form method=\"post\">
          ...
          <div class=\"form-group\">
            <label for=\"contenu\">Contenu</label>
            <textarea id=\"contenu\" name=\"contenu\" class=\"form-control\" required=\"required\" >{{ crTrouve.getContenu() }}</textarea>
          </div>
            <div class=\"card-body\">
              <a class=\"btn btn-success \" href=\"{{ path('view_back_reunion', {id : reunionTrouvee.getId()}) }}\" role=\"button\">Afficher</a>
              <input type=\"submit\" value=\"Modifier\" class=\"btn btn-primary\">
            </div>
        </form>
      </div>
...
{% endblock %}
", "reunions/editCr.html.twig", "C:\\xampp\\htdocs\\moto_club\\templates\\reunions\\editCr.html.twig");
    }
}
