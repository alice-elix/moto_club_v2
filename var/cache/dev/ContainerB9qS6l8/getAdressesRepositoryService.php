...
// Returns the private 'App\Repository\AdressesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AdressesRepository.php';

return $this->privates['App\\Repository\\AdressesRepository'] = new \App\Repository\AdressesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
