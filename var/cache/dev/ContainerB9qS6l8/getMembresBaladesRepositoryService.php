...
// Returns the private 'App\Repository\MembresBaladesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MembresBaladesRepository.php';

return $this->privates['App\\Repository\\MembresBaladesRepository'] = new \App\Repository\MembresBaladesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
