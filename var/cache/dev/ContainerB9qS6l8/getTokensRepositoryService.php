...
// Returns the private 'App\Repository\TokensRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TokensRepository.php';

return $this->privates['App\\Repository\\TokensRepository'] = new \App\Repository\TokensRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
